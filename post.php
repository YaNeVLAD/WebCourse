...
<body>
  <header class="header">
    <div class="header-content">
      <img src="images/EscapeHead.svg" class="header-content__logo" alt="No Logo">
  ...
  <div class="title-block">
    <h1 class="title-block__title"> The Road Ahead </h1>
    <p class="title-block__undertitle"> The road ahead might be paved - it might not be. </p>
  </div>

  <img class="banner" src="images/posts-images/the-road-ahead.png" alt="The Road Ahead">
